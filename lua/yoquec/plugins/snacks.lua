return {
    ...
    keys = {
        ...
        { "<leader>flD",  function() Snacks.picker.lsp_declarations() end,      desc = "Find LSP Declarations" },
        { "<leader>fli",  function() Snacks.picker.lsp_incoming_calls() end,    desc = "Find LSP Incoming calls" },
        { "<leader>flo",  function() Snacks.picker.lsp_outgoing_calls() end,    desc = "Find LSP external function calls" },
